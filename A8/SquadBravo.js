...
this.patrolList = [ [300,20, 380,90],
    ...
    this.getMoves = function() {
        ...
        for (var idx in tankList) {
         ...
         // returns list of all squadron tank requests to be concat with game update list
         return tankRequestList;
    };

    this.receiveMsg = function(msg) {
        // assume all msgs are for to tank t1 : plan intercept
        ...
        if (matchList != null) {
            ...
            // get index of tank closest to intercept position
