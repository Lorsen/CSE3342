 ...
 function drawTerrain() {
  ...
  function drawTerrainObj(terrObj) {
    ...
    if(terrObj.terrain == "water") {
      terrainRect.setAttribute("style", "stroke:#666600; fill: blue");
    } else if(terrObj.terrain == "mtn") {
      terrainRect.setAttribute("style", "stroke:#666600; fill: brown");
    } else if(terrObj.terrain == "forest") {
        terrainRect.setAttribute("style", "stroke:#666600; fill: green");
    } else if ( (terrObj.terrain).startsWith("hq") ) {
       terrainRect.setAttribute("style", "stroke:#666600; fill: yellow");
    } else {
